      ...
      <div className="space-y-6">
              ...
              <Tooltip>
                <TooltipTrigger asChild>
                  <Badge variant="outline" className="bg-primary/5 px-3 py-1 text-xs font-medium">
                    {isEditing ? (
                      <Select value={editedAppName} onValueChange={setEditedAppName}>
        ...
        <div className="space-y-2">
          ...
          <div className="group">
            <div
              className={cn(
                "relative rounded-lg border border-border/50 bg-card p-4 shadow-sm transition-all duration-200",
            ...
            >
              {isEditing ? (
                <Textarea
                  ...
                  className="min-h-[150px] resize-none border-none p-0 focus-visible:ring-0 focus-visible:ring-offset-0"
                />
              ) : (
                <>
        ...
        <div className="space-y-2">
          ...
          >
            {isEditing ? (
              ...
              <p className="whitespace-pre-wrap text-sm leading-relaxed break-words">{howToUse}</p>
            )}
          </div>
        </div>
      </div>

            ...
            <CardContent>
                ...
                <ul className="space-y-2">
                    {newsItems.map((item : any, index : any) => (
                        <li key={index} className="border-b border-gray-300 dark:border-gray-600 last:border-b-0 pb-2">
                            <div className="flex items-center space-x-4">
                                <time className="text-sm text-gray-500 dark:text-gray-300 whitespace-nowrap" dateTime={item.date}>

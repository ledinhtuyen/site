...
import { deletePrompts } from "../_lib/actions";

interface PromptsTableFloatingBarProps {
  table: Table<Prompt>;
}

export function PromptsTableFloatingBar({ table }: PromptsTableFloatingBarProps) {
                  ...
                  <Button
                    ...
                    onClick={() => {
                      ...
                      startTransition(async () => {
                        try {
                          await deletePrompts(rows.map((row) => row.original.promptId));
